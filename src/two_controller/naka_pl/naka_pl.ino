...
void loop() {
  ...
  //通常コントローラー値受信
  shita_table_yoko = map(testch[1], 364, 1684, 364, 1684); //下 テーブルよこ
  shita_tate = map(testch[3], 364, 1684, -100, 100); //下 たて
  shita_yoko = map(testch[2], 364, 1684, -255, 255); //下 よこ
  shita_table_revo = map(testch[0], 364, 1684, 364, 1684); //下 テーブル回転
  ...
  shita_msg.buf[3] = send_can_robot_stop;
